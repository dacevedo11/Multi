 ...
 */
UCLASS(abstract)
class MULTI_API AShooterWeapon : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	UFUNCTION()
	void OnRep_CurrentBullets() const;
...
public:	
	...
	/** Adds ammo pickup to current bullets */
	void AddAmmo(int32 Amount);

	/** Checks if ammo is full or not */
	bool bIsFullAmmo() const;

	void SetCurrentBullets(int32 InCurrentBullets);
};
